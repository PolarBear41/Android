...
public class FragmentLoginBindingImpl extends FragmentLoginBinding implements com.example.irentmovie.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener etPasswordandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            com.example.irentmovie.ui.login.LoginViewModel viewModel = mViewModel;
            // viewModel.password
    ...
    private FragmentLoginBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback5 = new com.example.irentmovie.generated.callback.OnClickListener(this, 1);
        mCallback6 = new com.example.irentmovie.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.listener == variableId) {
            setListener((com.example.irentmovie.ui.login.LoginFragmentListener) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((com.example.irentmovie.ui.login.LoginViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setListener(@Nullable com.example.irentmovie.ui.login.LoginFragmentListener Listener) {
    ...
    public void setViewModel(@Nullable com.example.irentmovie.ui.login.LoginViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String viewModelPasswordGetValue = null;
        java.lang.String viewModelUsernameGetValue = null;
        com.example.irentmovie.ui.login.LoginFragmentListener listener = mListener;
        com.example.irentmovie.ui.login.LoginViewModel viewModel = mViewModel;
        androidx.lifecycle.MutableLiveData<java.lang.String> viewModelUsername = null;
        androidx.lifecycle.MutableLiveData<java.lang.String> viewModelPassword = null;
        ...
        if ((dirtyFlags & 0x10L) != 0) {
            ...
            this.btnRegister.setOnClickListener(mCallback6);
