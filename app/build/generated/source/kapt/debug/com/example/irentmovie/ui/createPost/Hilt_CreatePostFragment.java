 ...
 */
public abstract class Hilt_CreatePostFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreatePostFragment() {
    super();
  }

  Hilt_CreatePostFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreatePostFragment_GeneratedInjector) this.generatedComponent()).injectCreatePostFragment(UnsafeCasts.<CreatePostFragment>unsafeCast(this));
    }
  }
