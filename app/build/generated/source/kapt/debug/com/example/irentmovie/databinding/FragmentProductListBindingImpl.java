...
public class FragmentProductListBindingImpl extends FragmentProductListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.irentmovie.ui.productList.ProductListViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.irentmovie.ui.productList.ProductListViewModel ViewModel) {
