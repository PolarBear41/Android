...
public abstract class Hilt_ProductListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductListFragment() {
    super();
  }

  Hilt_ProductListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductListFragment_GeneratedInjector) this.generatedComponent()).injectProductListFragment(UnsafeCasts.<ProductListFragment>unsafeCast(this));
    }
  }
