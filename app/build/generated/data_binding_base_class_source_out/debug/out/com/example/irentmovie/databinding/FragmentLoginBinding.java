...
import com.example.irentmovie.ui.login.LoginFragmentListener;
...
public abstract class FragmentLoginBinding extends ViewDataBinding {
  ...
  @Bindable
  protected LoginFragmentListener mListener;

  @Bindable
  protected LoginViewModel mViewModel;

  protected FragmentLoginBinding(Object _bindingComponent, View _root, int _localFieldCount,
      Button btnLogin, Button btnRegister, EditText etPassword, EditText etUsername) {
  ...
  public abstract void setListener(@Nullable LoginFragmentListener listener);

  @Nullable
  public LoginFragmentListener getListener() {
    return mListener;
  }
